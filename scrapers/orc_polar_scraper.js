...
( async () => {
    ...
    var polarsRequest = await axios.get('https://jieter.github.io/orc-data/site/index.json')
    ...
    for(polarIndex in polarsList){
        ...
        var polarDataRequest = await axios.get('https://jieter.github.io/orc-data/site/data/' + p[0] + '.json')
